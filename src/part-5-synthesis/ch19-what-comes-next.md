...
I started on a mainframe terminal in 1990. I'm ending on a mesh of mini-PCs in 2026. The hardware changed. The networks changed. The languages changed. But the fundamental problem -- building systems that are truthful, resilient, and comprehensible -- hasn't changed at all. I've just gotten better at recognizing what matters and what doesn't. What matters is immutable truth, loose coupling, human oversight, and the humility to let the system evolve beyond what you designed. What doesn't matter is everything else -- the frameworks, the cloud providers, the hype cycles, the conference talks. They come and go. The principles remain.
