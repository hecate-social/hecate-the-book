...
CHAPTERS=(
    ...
    "${SRC_DIR}/part-4-platform/ch13-the-venture-lifecycle.md"
    "${SRC_DIR}/part-4-platform/ch14-plugin-architecture.md"
    "${SRC_DIR}/part-4-platform/ch15-martha-studio.md"
    "${SRC_DIR}/part-4-platform/ch16-the-agent-relay.md"
